...
1. Open the web app at <https://ees3310.jgilligan.org/decarbonization>, 
   select the OECD as the country or region.  
   Leave the 
...
5. Calculate the emissions target: Set the reference year for 
...
8. How does the implied rate of decarbonization for the OECD compare to the 
