...
pubdate: '2019-12-31'
date: '2020-02-17'
bibliography: lab-06.bib
pdf_url: /files/lab_docs/lab_06/citations_bibliographies.pdf
slug: lab_06_citations_bibliographies
fontsize: 12pt
output:
  blogdown::html_page:
...
extension (`.bib`, etc.). I have provided an example BibTeX file, `lab-06.bib` 
...
or BibLaTeX format (as a `.biblatex` file). I can help if you decide to 
...
RMarkdown also claims to support the following file types as well, but I 
have not tried them, so I would not be able to provide much help if you
try them and run into trouble, so if you're going to get fancy with 
RMarkdown bibliographies I would recommend that you use either `.ris`, 
`.bib`, or `.biblatex` files.
...
* From Google Scholar, you can export a BibTeX entry: 
    ...
    2. When you find the reference you want in Google Scholar, and click on the 
       ""Cite"" button, as shown below:
        ...
        ![Google Scholar search page. Click on the ""Cite"" button, as shown here.](_images/lab_06/scholar_1.png)\

    3. Click on ""BibTeX"" at the bottom of the citation page, as shown below:

        ![Google Scholar citation page: Click on ""BibTeX""](_images/lab_06/scholar_2.png)\
