...
pubdate: '2019-12-31'
date: '2020-01-13'
pdf_url: /files/lab_doocs/lab_02/lab_02_layer_model.pdf
...
* You can do the exercises out of the book like regular homework and
  turn them in at the beginning of class on ., . .

* You can do them using RMarkdown and turn them by submitting them 
  electronically on GitHub by ., . .
    ...
    * Push the changes from your local git repository to github.
         ...
         The last changes that you push before the due date (start of class on ., . ) will be graded.
