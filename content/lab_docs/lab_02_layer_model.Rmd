---
title: Energy Balance and Layer Models of the Atmosphere
lab_number: 2
lab_date: '2020-01-13'
pubdate: '2019-12-31'
date: '2020-01-13'
pdf_url: /files/lab_docs/lab_02/lab_02_layer_model.pdf
slug: lab_02_layer_model
output:
  blogdown::html_page:
...
* You can do the exercises out of the book like regular homework and
  turn them in at the beginning of class on Wed., Jan. 22.

* You can do them using RMarkdown and turn them by submitting them 
  electronically on GitHub by Wed., Jan. 22.
    ...
    * Push the changes from your local git repository to github.
         ...
         The last changes that you push before the due date (start of class on Wed., Jan. 22) will be graded.
