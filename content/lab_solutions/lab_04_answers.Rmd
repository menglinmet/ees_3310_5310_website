...
(ref:low_cloud_caption) Upward and downward fluxes of longwave and shortwave 
radiation with 70% of the sky covered by low clouds.

```{r ex-3-a-figure, fig.cap='(ref:low_cloud_caption)'}
...
(ref:high_cloud_caption) Upward and downward fluxes of longwave and shortwave 
radiation with 20% of the sky covered by high clouds.

```{r ex-3-b-figure, fig.cap='(ref:high_cloud_caption)'}
