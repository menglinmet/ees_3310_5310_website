  ...
  \iffalse
    \item The mid-term test is on
      \textbf{\Sexpr{format_day_date_range_by_event_id(calendar,
         c("MIDTERM_EXAM","MIDTERM_TEST"),abbr_month = FALSE,
           abbr_wday = FALSE)}}.
  \fi
  \item On
    %
...
\item The midterm exam will be a take-home test of your knowledge about the
    ...
    due on
    \textbf{\Sexpr{format_day_date_by_key(semester$calendar, "MIDTERM_EXAM", "exam")}}
...
<<r grading, include=F>>=
grade_weights <- c(participation = 5, homework = 0, midterm = 10, lab = 55, final = 30)
...
one_line_events <- c("MLK_DAY", "MIDTERM_TEST", "MIDTERM_EXAM")
...
schedule_break_row <- max(long_holiday_rows)
